...
.center[
http://github.com/crsh/reproducible-research-practices-workshop
]
...
sharing_options <- data.frame(
  ...
  , "&nbsp;" = "&nbsp;"
  , "What?" = c("<i>Lunch break</i>", "Git & GitHub for collaboration - Part 2", "<i>Coffee break</i>", "Other tools & workflows", "Wrap-Up")
  , check.names = FALSE
)
knitr::kable(
  sharing_options
