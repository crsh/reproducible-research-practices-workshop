...
- `[see @bem_2011 for a surpising result]` yields<br />"(see Bem, 2011, for a surpising result)"
...
increasing RT differences between regular and nonregular transitions is a measure of sequence-specific learning
